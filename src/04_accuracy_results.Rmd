...
p1_a <- ggplot2::ggplot(
  data = flight_data,
  mapping = ggplot2::aes(x = config)
) +
  ggplot2::geom_col(
    mapping = ggplot2::aes(y = flight_time_min_ha, fill = "Flight Time"),
    width = 0.4,
    position = ggplot2::position_nudge(x = -0.2)
  ) +
  ggplot2::geom_col(
    mapping = ggplot2::aes(y = proc_time_min_ha / 2, fill = "Processing Time"),
    width = 0.4,
    position = ggplot2::position_nudge(x = 0.2)
  ) +
  ggplot2::scale_y_continuous(
...
p1_b <- ggplot2::ggplot(
  data = flight_data,
  mapping = ggplot2::aes(x = config, y = f_score, group = 1)
) +
  ggplot2::geom_line(color = "#1b9e77", linewidth = 1) +
  ggplot2::geom_point(color = "#1b9e77", size = 3) +
  ggplot2::scale_y_continuous(name = "F-score", limits = c(0.7, 1.0)) +
  ggplot2::theme_bw() +
  ggplot2::theme(
    axis.title.x = ggplot2::element_blank(),
    axis.text.x = ggplot2::element_blank()
...
p1_c <- ggplot2::ggplot(
  data = flight_data,
  mapping = ggplot2::aes(x = config, group = 1)
) +
  ggplot2::geom_line(
    mapping = ggplot2::aes(y = dbh_rmse_cm, color = "DBH RMSE (cm)"),
    linewidth = 1
  ) +
  ggplot2::geom_point(
    mapping = ggplot2::aes(y = dbh_rmse_cm, color = "DBH RMSE (cm)"),
  ...
  ggplot2::geom_line(
    mapping = ggplot2::aes(y = height_rmse_m * 5, color = "Height RMSE (m)"),
    linewidth = 1,
    linetype = "dashed"
  ) +
  ggplot2::geom_point(
...
p1_d <- ggplot2::ggplot(
  ...
  ggplot2::geom_col(
    mapping = ggplot2::aes(y = tph_diff_pct, fill = "TPH Difference (%)"),
    width = 0.35,
    position = ggplot2::position_nudge(x = -0.2)
  ) +
  ggplot2::geom_col(
    mapping = ggplot2::aes(y = ba_diff_pct, fill = "BA Difference (%)"),
    width = 0.35,
    position = ggplot2::position_nudge(x = 0.2)
  ) +
...
fig_option_1 <- patchwork::wrap_plots(p1_a, p1_b, p1_c, p1_d, ncol = 1)
print(fig_option_1)
...
p2_a <- ggplot2::ggplot(
  ...
  ggplot2::geom_text(
    mapping = ggplot2::aes(label = config),
    vjust = -1,
    size = 3,
    show.legend = FALSE
  ) +
...
p2_b <- ggplot2::ggplot(
  data = dplyr::mutate(
    flight_data,
    total_time_min_ha = flight_time_min_ha + proc_time_min_ha
  ),
  mapping = ggplot2::aes(
    x = total_time_min_ha,
    y = height_rmse_m,
...
p3_data <- flight_data |>
  ...
  dplyr::mutate(
    metric = factor(
      metric,
      levels = c(
        "flight_time_min_ha_scaled",
        "proc_time_min_ha_scaled",
        "f_score_scaled",
        "dbh_rmse_cm_scaled",
        "height_rmse_m_scaled",
        "tph_diff_pct_scaled",
        "ba_diff_pct_scaled"
      ),
      labels = c(
...
p4_a <- ggplot2::ggplot(
  data = flight_data,
  mapping = ggplot2::aes(x = config, y = flight_time_min_ha + proc_time_min_ha)
) +
...
p4_b <- ggplot2::ggplot(
  data = p4_matrix_data,
  mapping = ggplot2::aes(x = config, y = metric_label)
) +
  ggplot2::geom_tile(
...
fig_option_4 <- patchwork::wrap_plots(p4_a, p4_b, ncol = 1, heights = c(1, 2))
print(fig_option_4)
