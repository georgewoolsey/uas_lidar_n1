...
altitude alone is significant at the 0.05 level while speed is significant at the 0.1 level. this finding is evidence that the flight settings of altitude and speed influence basal area error but note that the estimated coefficient on those variables is very small.
...
speed alone is significant at the 0.05 level while altitude alone and the interaction between speed and altitude are significant at the 0.1 level. this finding is evidence that the flight settings of altitude and speed influence tree density error but note that the estimated coefficient on those variables is very small.
