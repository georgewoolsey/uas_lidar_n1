...
Because Bray-Curtis is a **dissimilarity** measure and Schoener's D (total overlap) index which we looked at above is a **similarity** measure, they can be interpreted as $\textrm{Bray-Curtis}_{dissimilarity} \approx 1-\textrm{Schoener}_{similarity}$
