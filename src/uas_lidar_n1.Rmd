...
dta_temp %>% 
  ...
  ggplot2::facet_wrap(facets = dplyr::vars(dataset_factor), axes = "all") +
  ggplot2::scale_x_continuous(breaks = scales::breaks_extended(n=11)) +
  ggplot2::scale_y_continuous(labels = scales::percent) +
...
ggplot2::ggsave("c:/users/georg/Downloads/n1validation_prdetect_flight.jpg", height = 10.5, width = 8)
